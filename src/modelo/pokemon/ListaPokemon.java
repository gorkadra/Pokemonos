...
public class ListaPokemon {
	...
	public Pokemon crearPokemon(int pokemonId) {
		Pokemon deseado = this.buscarPokemonId(pokemonId); //aleatorioki erabakitako model.pokemon-a pokedex osoan bilatzean, bariable horretan gordetzeko
		deseado.asignarMovim(); // aurkitu dugun model.pokemon-ari mugimenduak esleitzeko
		return deseado;
	}
